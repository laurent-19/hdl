...
module ad7768_if (
 ...
 always @(posedge adc_clk) begin
   adc_crc_ch_mismatch_s[0] <= (adc_valid_s_d == 1'b1 ) ? adc_crc_mismatch_s_0 : adc_crc_ch_mismatch_s[0];
   adc_crc_ch_mismatch_s[1] <= (adc_valid_s_d == 1'b1 ) ? adc_crc_mismatch_s_1 : adc_crc_ch_mismatch_s[1];
   adc_crc_ch_mismatch_s[2] <= (adc_valid_s_d == 1'b1 ) ? adc_crc_mismatch_s_2 : adc_crc_ch_mismatch_s[2];
   adc_crc_ch_mismatch_s[3] <= (adc_valid_s_d == 1'b1 ) ? adc_crc_mismatch_s_3 : adc_crc_ch_mismatch_s[3];
   adc_crc_ch_mismatch_s[4] <= (adc_valid_s_d == 1'b1 ) ? adc_crc_mismatch_s_4 : adc_crc_ch_mismatch_s[4];
   adc_crc_ch_mismatch_s[5] <= (adc_valid_s_d == 1'b1 ) ? adc_crc_mismatch_s_5 : adc_crc_ch_mismatch_s[5];
...
always @(posedge adc_clk) begin
  ...
  always @(posedge adc_clk) begin
    if (adc_crc_valid_p == 1'b0) begin
      ...
      adc_crc_read_data_3 <=adc_data_3_s[31:24];
      adc_crc_read_data_4 <=adc_data_4_s[31:24];
