...
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { spi_sckl }]; #IO_L7N_T1_34 Sch=ja_n[2]
...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { m2k_sckl }]; #IO_L1N_T0_34 Sch=jb_n[2]
