...
module system_top (
  ...
  assign mclk = 1'b0;
  assign shutdown_n = gpio_o[39];
  assign start_n = gpio_o[38];
  assign reset_n = gpio_o[37];
  ...
  system_bd i_system_bd (
    ...
    .up_crc_4_or_16_n_bd_up_crc_4_or_16_n(up_crc_4_or_16_n),
    .up_crc_enable_bd_up_crc_enable(up_crc_enable),
    .up_format_bd_up_format(up_format),
    .up_sshot_bd_up_sshot(up_sshot),
    .up_status_bd_up_status(), //gpio_i[32:0]
    .up_status_clr_bd_up_status_clr(), //gpio_o[32:0]
